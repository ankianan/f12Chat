...
function B(a,b,e){this.props=a;this.context=b;this.refs=emptyObject_1;this.updater=e||z;}function C(){}C.prototype=A.prototype;var D=B.prototype=new C;D.constructor=B;objectAssign(D,A.prototype);D.isPureReactComponent=!0;function E$1(a,b,e){this.props=a;this.context=b;this.refs=emptyObject_1;this.updater=e||z;}var F=E$1.prototype=new C;F.constructor=E$1;objectAssign(F,A.prototype);F.unstable_isAsyncReactComponent=!0;F.render=function(){return this.props.children};var G={current:null}; var H=Object.prototype.hasOwnProperty; var I={key:!0,ref:!0,__self:!0,__source:!0};
function J(a,b,e){var c,d={},g=null,k=null;if(null!=b)for(c in void 0!==b.ref&&(k=b.ref),void 0!==b.key&&(g=""+b.key),b)H.call(b,c)&&!I.hasOwnProperty(c)&&(d[c]=b[c]);var f=arguments.length-2;if(1===f)d.children=e;else if(1<f){for(var h=Array(f),l=0;l<f;l++)h[l]=arguments[l+2];d.children=h;}if(a&&a.defaultProps)for(c in f=a.defaultProps,f)void 0===d[c]&&(d[c]=f[c]);return{$$typeof:r,type:a,key:g,ref:k,props:d,_owner:G.current}}function K$1(a){return"object"===typeof a&&null!==a&&a.$$typeof===r}
function escape(a){var b={"\x3d":"\x3d0",":":"\x3d2"};return"$"+(""+a).replace(/[=:]/g,function(a){return b[a]})}var L=/\/+/g; var M$1=[];function N(a,b,e,c){if(M$1.length){var d=M$1.pop();d.result=a;d.keyPrefix=b;d.func=e;d.context=c;d.count=0;return d}return{result:a,keyPrefix:b,func:e,context:c,count:0}}function O(a){a.result=null;a.keyPrefix=null;a.func=null;a.context=null;a.count=0;10>M$1.length&&M$1.push(a);}
function P$1(a,b,e,c){var d=typeof a;if("undefined"===d||"boolean"===d)a=null;var g=!1;if(null===a)g=!0;else switch(d){case "string":case "number":g=!0;break;case "object":switch(a.$$typeof){case r:case t:case u:case v:g=!0;}}if(g)return e(c,a,""===b?"."+Q$1(a,0):b),1;g=0;b=""===b?".":b+":";if(Array.isArray(a))for(var k=0;k<a.length;k++){d=a[k];var f=b+Q$1(d,k);g+=P$1(d,f,e,c);}else if(null===a||"undefined"===typeof a?f=null:(f=x&&a[x]||a["@@iterator"],f="function"===typeof f?f:null),"function"===typeof f)for(a=
f.call(a),k=0;!(d=a.next()).done;)d=d.value,f=b+Q$1(d,k++),g+=P$1(d,f,e,c);else"object"===d&&(e=""+a,y("31","[object Object]"===e?"object with keys {"+Object.keys(a).join(", ")+"}":e,""));return g}function Q$1(a,b){return"object"===typeof a&&null!==a&&null!=a.key?escape(a.key):b.toString(36)}function R(a,b){a.func.call(a.context,b,a.count++);}
function S$1(a,b,e){var c=a.result,d=a.keyPrefix;a=a.func.call(a.context,b,a.count++);Array.isArray(a)?T$1(a,c,e,emptyFunction_1.thatReturnsArgument):null!=a&&(K$1(a)&&(b=d+(!a.key||b&&b.key===a.key?"":(""+a.key).replace(L,"$\x26/")+"/")+e,a={$$typeof:r,type:a.type,key:b,ref:a.ref,props:a.props,_owner:a._owner}),c.push(a));}function T$1(a,b,e,c,d){var g="";null!=e&&(g=(""+e).replace(L,"$\x26/")+"/");b=N(b,g,c,d);null==a||P$1(a,"",S$1,b);O(b);}
var U$1={Children:{map:function(a,b,e){if(null==a)return a;var c=[];T$1(a,c,null,b,e);return c},forEach:function(a,b,e){if(null==a)return a;b=N(null,null,b,e);null==a||P$1(a,"",R,b);O(b);},count:function(a){return null==a?0:P$1(a,"",emptyFunction_1.thatReturnsNull,null)},toArray:function(a){var b=[];T$1(a,b,null,emptyFunction_1.thatReturnsArgument);return b},only:function(a){K$1(a)?void 0:y("143");return a}},Component:A,PureComponent:B,unstable_AsyncComponent:E$1,Fragment:w,createElement:J,cloneElement:function(a,b,e){var c=objectAssign({},a.props),
d=a.key,g=a.ref,k=a._owner;if(null!=b){void 0!==b.ref&&(g=b.ref,k=G.current);void 0!==b.key&&(d=""+b.key);if(a.type&&a.type.defaultProps)var f=a.type.defaultProps;for(h in b)H.call(b,h)&&!I.hasOwnProperty(h)&&(c[h]=void 0===b[h]&&void 0!==f?f[h]:b[h]);}var h=arguments.length-2;if(1===h)c.children=e;else if(1<h){f=Array(h);for(var l=0;l<h;l++)f[l]=arguments[l+2];c.children=f;}return{$$typeof:r,type:a.type,key:d,ref:g,props:c,_owner:k}},createFactory:function(a){var b=J.bind(null,a);b.type=a;return b},
isValidElement:K$1,version:"16.2.0",__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:{ReactCurrentOwner:G,assign:objectAssign}};
var V$1=Object.freeze({default:U$1});
...
var getFileName = function getFileName() {
  ...
  var date = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : todaysDate;
...
var mergeMessages = function mergeMessages() {
  ...
  var receivedMessages = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];

  return sentMessages.concat(receivedMessages).sort(function (a, b) {
...
var fetchChat = function fetchChat() {
  var username = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
  var peerUsername = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
  var date = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : todaysDate;

  var sentMessagePromise = getFile(getFileName(peerUsername, date), { username: username }).then(function (file) {
    return JSON.parse(file || '[]');
  });
  var receivedMessagePromise = getFile(getFileName(username, date), { username: peerUsername }).then(function (file) {
    return JSON.parse(file || '[]');
  });
  return Promise.all([sentMessagePromise, receivedMessagePromise], function (sentMessages, receivedMessages) {
    return {
...
var saveChat = function saveChat() {
  var peerUsername = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
  var sentMessages = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];

  var now = new Date();
  var fileName = getFileName(peerUsername, now);
...
var defaultSentMessage = [];
var defaultViewedMessage = [];

var ChatList = function (_React$PureComponent) {
  inherits(ChatList, _React$PureComponent);

  function ChatList() {
    classCallCheck(this, ChatList);

    var _this = possibleConstructorReturn(this, (ChatList.__proto__ || Object.getPrototypeOf(ChatList)).apply(this, arguments));

    _this.lastMountTimestamp = "";
    _this.sentMessage = defaultSentMessage; //Store sent messages for backup on peer change
    _this.state = {
  ...
  createClass(ChatList, [{
    ...
    value: function submitMessage(event) {
      var text = event.target.elements["textMessage"].value;
      var senderName = this.props.userProfile.name;
      var sendMessage = ChatList.createMessage({ text: text, senderName: senderName });
      this.setState({
    ...
    key: "refreshChatList",
    value: function refreshChatList() {
      var _this2 = this;

      var _props = this.props,
          userProfile = _props.userProfile,
          peerProfile = _props.peerProfile;
      ...
      if (userProfile.name && peerProfile.name) {
        fetchChat(userProfile.name, peerProfile.name).then(function (_ref) {
          var messages = _ref.messages;

          _this2.setState({
            messages: messages
          });
          _this2.sentMessages = sentMessage;
        });
      }
    }
  }, {
      ...
      return react.createElement(
        ...
        react.createElement(
          ...
          react.createElement(
            ...
            props.peerProfile.name
          ),
          messages.map(function (message$$1) {
            return react.createElement(
              "div",
              { "class": "collection-item" },
              message$$1.text,
              ChatList.getTimePassedSinceStr(message$$1.timestamp, _this3.lastMountTimestamp)
            );
          })
        ),
        react.createElement(
          ...
          react.createElement("input", { type: "text", name: "textMessage" }),
...
ChatList.getTimePassedSinceStr = function (timestamp, sinceTimeStamp) {
  var oneDay = 24 * 60 * 60 * 1000;
  var oneHour = 60 * 60 * 1000;
  var oneMinute = 60 * 1000;
  var diffTime = sinceTimeStamp - timestamp;
  var dueDateStr = "";

  if (Math.abs(diffTime) > oneDay) {

    var daysAgo = parseInt(Math.round(Math.abs(diffTime) / oneDay));
    var dayStr = daysAgo > 1 ? "days" : "day";
    ...
    var hoursAgo = parseInt(Math.round(Math.abs(diffTime) / oneHour));
    var hourStr = hoursAgo > 1 ? "hours" : "hour";
    ...
    var minutesAgo = parseInt(Math.round(Math.abs(diffTime) / oneMinute));
    var minuteStr = minutesAgo > 1 ? "mins" : "min";
...
ChatList.createMessage = function (_ref2) {
  var text = _ref2.text,
...
var Chat = function (_React$PureComponent) {
  inherits(Chat, _React$PureComponent);

  function Chat() {
    classCallCheck(this, Chat);

    var _this = possibleConstructorReturn(this, (Chat.__proto__ || Object.getPrototypeOf(Chat)).apply(this, arguments));
  ...
  createClass(Chat, [{
    ...
    key: "setSelectedPeerProfile",
    value: function setSelectedPeerProfile(profile) {
      this.setState({
    ...
    value: function render() {
      return react.createElement(
        ...
        react.createElement(ChatMembers, { onSelect: setSelectedPeerProfile }),
        selectedPeerProfile && react.createElement(ChatList, { userProfile: this.props.userProfile, peerProfile: this.state.selectedPeerProfile })
      );
    }
  }]);
  return Chat;
...
var App = function (_React$PureComponent) {
  inherits(App, _React$PureComponent);

  function App() {
    classCallCheck(this, App);

    var _this = possibleConstructorReturn(this, (App.__proto__ || Object.getPrototypeOf(App)).apply(this, arguments));
  ...
  createClass(App, [{
    ...
    value: function render() {
      if (userProfile && userProfile.name) {
        return react.createElement(Chat, { userProfile: this.state.userProfile });
      }
      return react.createElement(
        "section",
        { id: "section-1" },
...
var connect = send = function send(message) {
